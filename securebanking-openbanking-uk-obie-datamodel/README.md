...
When a new version of OB API is released, the following steps should be performed:
 ...
 2. Place the swagger files under `securebanking-openbanking-uk-obie-datamodel/src/main/resources/specification` (replacing existing ones where applicable).
 3. Override the configuration on `securebanking-openbanking-uk-obie-datamodel/pom.xml` to generate the proper source code.
 ...
 5. Check the generated files:
    ...
    check `securebanking-openbanking-uk-obie-datamodel/src/main/java/uk/org/openbaning/datamodel/common` and
       `securebanking-openbanking-uk-obie-datamodel/src/main/java/uk/org/openbaning/datamodel/error`
 ...
 6. Copy them into the appropriate source folders: (e.g. `securebanking-openbanking-uk-obie-datamodel/src/main/java`).
