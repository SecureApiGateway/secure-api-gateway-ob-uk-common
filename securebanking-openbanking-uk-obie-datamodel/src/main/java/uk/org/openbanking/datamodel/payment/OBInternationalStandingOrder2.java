...
public class OBInternationalStandingOrder2 {
    ...
    public OBInternationalStandingOrder2 frequency(String frequency) {
    ...
    public OBInternationalStandingOrder2 reference(String reference) {
    ...
    public OBInternationalStandingOrder2 numberOfPayments(String numberOfPayments) {
    ...
    public OBInternationalStandingOrder2 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBInternationalStandingOrder2 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
    ...
    public OBInternationalStandingOrder2 purpose(String purpose) {
    ...
    public OBInternationalStandingOrder2 chargeBearer(OBChargeBearerType1Code chargeBearer) {
    ...
    public OBInternationalStandingOrder2 currencyOfTransfer(String currencyOfTransfer) {
    ...
    public OBInternationalStandingOrder2 instructedAmount(OBActiveOrHistoricCurrencyAndAmount instructedAmount) {
    ...
    public OBInternationalStandingOrder2 debtorAccount(OBCashAccount3 debtorAccount) {
    ...
    public OBInternationalStandingOrder2 creditor(OBPartyIdentification43 creditor) {
    ...
    public OBInternationalStandingOrder2 creditorAgent(OBBranchAndFinancialInstitutionIdentification3 creditorAgent) {
    ...
    public OBInternationalStandingOrder2 creditorAccount(OBCashAccount3 creditorAccount) {
    ...
    public OBInternationalStandingOrder2 supplementaryData(OBSupplementaryData1 supplementaryData) {
    ...
    public boolean equals(Object o) {
        ...
        OBInternationalStandingOrder2 obInternationalStandingOrder2 = (OBInternationalStandingOrder2) o;
        return Objects.equals(this.frequency, obInternationalStandingOrder2.frequency) &&
                Objects.equals(this.reference, obInternationalStandingOrder2.reference) &&
                Objects.equals(this.numberOfPayments, obInternationalStandingOrder2.numberOfPayments) &&
                Objects.equals(this.firstPaymentDateTime, obInternationalStandingOrder2.firstPaymentDateTime) &&
                Objects.equals(this.finalPaymentDateTime, obInternationalStandingOrder2.finalPaymentDateTime) &&
                Objects.equals(this.purpose, obInternationalStandingOrder2.purpose) &&
                Objects.equals(this.chargeBearer, obInternationalStandingOrder2.chargeBearer) &&
                Objects.equals(this.currencyOfTransfer, obInternationalStandingOrder2.currencyOfTransfer) &&
                Objects.equals(this.instructedAmount, obInternationalStandingOrder2.instructedAmount) &&
                Objects.equals(this.debtorAccount, obInternationalStandingOrder2.debtorAccount) &&
                Objects.equals(this.creditor, obInternationalStandingOrder2.creditor) &&
                Objects.equals(this.creditorAgent, obInternationalStandingOrder2.creditorAgent) &&
                Objects.equals(this.creditorAccount, obInternationalStandingOrder2.creditorAccount) &&
                Objects.equals(this.supplementaryData, obInternationalStandingOrder2.supplementaryData);
    }
