...
public class OBWriteDataDomesticScheduledConsentResponse2 {
    ...
    public OBWriteDataDomesticScheduledConsentResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse2 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse2 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse2 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
