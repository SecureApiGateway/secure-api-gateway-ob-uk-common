...
public class OBFundsConfirmationConsentResponse1Data {
    ...
    public OBFundsConfirmationConsentResponse1Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBFundsConfirmationConsentResponse1Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBFundsConfirmationConsentResponse1Data expirationDateTime(OffsetDateTime expirationDateTime) {
