...
public class OBBCAData1FeeChargeDetail {
    ...
    public OBBCAData1FeeChargeDetail otherFeeType(OtherFeeType otherFeeType) {
    ...
    public OBBCAData1FeeChargeDetail otherFeeRateType(OtherFeeRateType otherFeeRateType) {
