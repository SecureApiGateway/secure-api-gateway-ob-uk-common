...
public class OBWriteDataDomesticScheduledResponse2 {
    ...
    public OBWriteDataDomesticScheduledResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse2 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse2 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
