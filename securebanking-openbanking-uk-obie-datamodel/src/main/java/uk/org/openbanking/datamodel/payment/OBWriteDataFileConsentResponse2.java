...
public class OBWriteDataFileConsentResponse2 {
    ...
    public OBWriteDataFileConsentResponse2 consentId(String consentId) {
    ...
    public OBWriteDataFileConsentResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataFileConsentResponse2 status(OBExternalConsentStatus2Code status) {
        this.status = status;
        return this;
    }
    ...
    public OBWriteDataFileConsentResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataFileConsentResponse2 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataFileConsentResponse2 charges(List<OBCharge1> charges) {
        this.charges = charges;
        return this;
    }

    public OBWriteDataFileConsentResponse2 addChargesItem(OBCharge1 chargesItem) {
    ...
    public OBWriteDataFileConsentResponse2 initiation(OBFile2 initiation) {
    ...
    public OBWriteDataFileConsentResponse2 authorisation(OBAuthorisation1 authorisation) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDataFileConsentResponse2 obWriteDataFileConsentResponse2 = (OBWriteDataFileConsentResponse2) o;
        return Objects.equals(this.consentId, obWriteDataFileConsentResponse2.consentId) &&
                Objects.equals(this.creationDateTime, obWriteDataFileConsentResponse2.creationDateTime) &&
                Objects.equals(this.status, obWriteDataFileConsentResponse2.status) &&
                Objects.equals(this.statusUpdateDateTime, obWriteDataFileConsentResponse2.statusUpdateDateTime) &&
                Objects.equals(this.cutOffDateTime, obWriteDataFileConsentResponse2.cutOffDateTime) &&
                Objects.equals(this.charges, obWriteDataFileConsentResponse2.charges) &&
                Objects.equals(this.initiation, obWriteDataFileConsentResponse2.initiation) &&
                Objects.equals(this.authorisation, obWriteDataFileConsentResponse2.authorisation);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteDataFileConsentResponse2 {\n");
