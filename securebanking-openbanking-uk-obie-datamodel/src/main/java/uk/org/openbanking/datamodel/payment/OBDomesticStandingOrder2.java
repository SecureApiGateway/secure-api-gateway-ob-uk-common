...
public class OBDomesticStandingOrder2 {
    ...
    public OBDomesticStandingOrder2 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBDomesticStandingOrder2 recurringPaymentDateTime(OffsetDateTime recurringPaymentDateTime) {
    ...
    public OBDomesticStandingOrder2 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
