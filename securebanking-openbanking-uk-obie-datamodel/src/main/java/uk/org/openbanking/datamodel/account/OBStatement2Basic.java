...
public class OBStatement2Basic {
    ...
    public OBStatement2Basic statementBenefit(List<OBStatementBenefit1> statementBenefit) {
    ...
    public OBStatement2Basic statementFee(List<OBStatementFee2> statementFee) {
    ...
    public OBStatement2Basic statementInterest(List<OBStatementInterest2> statementInterest) {
    ...
    public OBStatement2Basic statementDateTime(List<OBStatementDateTime1> statementDateTime) {
    ...
    public OBStatement2Basic statementRate(List<OBStatementRate1> statementRate) {
    ...
    public OBStatement2Basic statementValue(List<OBStatementValue1> statementValue) {
