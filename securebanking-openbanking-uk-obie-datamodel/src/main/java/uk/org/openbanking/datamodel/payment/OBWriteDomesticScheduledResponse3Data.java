...
public class OBWriteDomesticScheduledResponse3Data {
    ...
    public OBWriteDomesticScheduledResponse3Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDomesticScheduledResponse3Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDomesticScheduledResponse3Data expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDomesticScheduledResponse3Data expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
