...
public class OBWriteInternational2   {
  @JsonProperty("Data")
  private OBWriteDataInternational2 data = null;

  @JsonProperty("Risk")
  private OBRisk1 risk = null;

  public OBWriteInternational2 data(OBWriteDataInternational2 data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public OBWriteDataInternational2 getData() {
    return data;
  }

  public void setData(OBWriteDataInternational2 data) {
    this.data = data;
  }
