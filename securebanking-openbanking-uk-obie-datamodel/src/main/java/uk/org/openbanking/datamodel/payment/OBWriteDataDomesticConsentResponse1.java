...
public class OBWriteDataDomesticConsentResponse1 {
    ...
    public OBWriteDataDomesticConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataDomesticConsentResponse1 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticConsentResponse1 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
