...
public class OBReadData1 {
    ...
    public OBReadData1 expirationDateTime(OffsetDateTime expirationDateTime) {
    ...
    public OBReadData1 transactionFromDateTime(OffsetDateTime transactionFromDateTime) {
    ...
    public OBReadData1 transactionToDateTime(OffsetDateTime transactionToDateTime) {
