...
public class OBWriteDataFileResponse1 {
    ...
    public OBWriteDataFileResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataFileResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
