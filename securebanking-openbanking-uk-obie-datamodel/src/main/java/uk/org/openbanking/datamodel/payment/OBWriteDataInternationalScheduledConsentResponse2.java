...
@Size(min=1,max=128) 
  ...
  public OBWriteDataInternationalScheduledConsentResponse2 creationDateTime(DateTime creationDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledConsentResponse2 statusUpdateDateTime(DateTime statusUpdateDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledConsentResponse2 cutOffDateTime(DateTime cutOffDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledConsentResponse2 expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledConsentResponse2 expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
