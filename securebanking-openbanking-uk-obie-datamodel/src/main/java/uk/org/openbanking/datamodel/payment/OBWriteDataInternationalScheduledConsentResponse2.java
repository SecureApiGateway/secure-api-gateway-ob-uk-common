...
public class OBWriteDataInternationalScheduledConsentResponse2 {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 consentId(String consentId) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 status(OBExternalConsentStatus1Code status) {
        this.status = status;
        return this;
    }
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 permission(OBExternalPermissions2Code permission) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 charges(List<OBCharge1> charges) {
        this.charges = charges;
        return this;
    }

    public OBWriteDataInternationalScheduledConsentResponse2 addChargesItem(OBCharge1 chargesItem) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 exchangeRateInformation(OBExchangeRate2 exchangeRateInformation) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 initiation(OBInternationalScheduled2 initiation) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse2 authorisation(OBAuthorisation1 authorisation) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDataInternationalScheduledConsentResponse2 obWriteDataInternationalScheduledConsentResponse2 = (OBWriteDataInternationalScheduledConsentResponse2) o;
        return Objects.equals(this.consentId, obWriteDataInternationalScheduledConsentResponse2.consentId) &&
                Objects.equals(this.creationDateTime, obWriteDataInternationalScheduledConsentResponse2.creationDateTime) &&
                Objects.equals(this.status, obWriteDataInternationalScheduledConsentResponse2.status) &&
                Objects.equals(this.statusUpdateDateTime, obWriteDataInternationalScheduledConsentResponse2.statusUpdateDateTime) &&
                Objects.equals(this.permission, obWriteDataInternationalScheduledConsentResponse2.permission) &&
                Objects.equals(this.cutOffDateTime, obWriteDataInternationalScheduledConsentResponse2.cutOffDateTime) &&
                Objects.equals(this.expectedExecutionDateTime, obWriteDataInternationalScheduledConsentResponse2.expectedExecutionDateTime) &&
                Objects.equals(this.expectedSettlementDateTime, obWriteDataInternationalScheduledConsentResponse2.expectedSettlementDateTime) &&
                Objects.equals(this.charges, obWriteDataInternationalScheduledConsentResponse2.charges) &&
                Objects.equals(this.exchangeRateInformation, obWriteDataInternationalScheduledConsentResponse2.exchangeRateInformation) &&
                Objects.equals(this.initiation, obWriteDataInternationalScheduledConsentResponse2.initiation) &&
                Objects.equals(this.authorisation, obWriteDataInternationalScheduledConsentResponse2.authorisation);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteDataInternationalScheduledConsentResponse2 {\n");
