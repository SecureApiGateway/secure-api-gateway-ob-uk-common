...
public class OBWriteDataDomesticStandingOrderResponse2 {
    ...
    public OBWriteDataDomesticStandingOrderResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticStandingOrderResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
