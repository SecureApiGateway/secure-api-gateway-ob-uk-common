...
public class OBWriteDataDomesticResponse1 {
    ...
    public OBWriteDataDomesticResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticResponse1 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticResponse1 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
