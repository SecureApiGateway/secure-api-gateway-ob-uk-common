...
public class OBReadDataResponse1 {
    ...
    public OBReadDataResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBReadDataResponse1 expirationDateTime(OffsetDateTime expirationDateTime) {
    ...
    public OBReadDataResponse1 transactionFromDateTime(OffsetDateTime transactionFromDateTime) {
    ...
    public OBReadDataResponse1 transactionToDateTime(OffsetDateTime transactionToDateTime) {
