...
public class OBWriteDataInternationalScheduledResponse1 {
    ...
    public OBWriteDataInternationalScheduledResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse1 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse1 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
