...
@Size(min=1,max=128) 
  ...
  public OBWriteDataInternationalScheduledResponse2 creationDateTime(DateTime creationDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledResponse2 statusUpdateDateTime(DateTime statusUpdateDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledResponse2 expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
  ...
  **/
  ...
  public OBWriteDataInternationalScheduledResponse2 expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
