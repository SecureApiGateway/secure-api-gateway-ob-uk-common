...
public class OBWriteDataInternationalScheduledResponse2 {
    ...
    public OBWriteDataInternationalScheduledResponse2 internationalScheduledPaymentId(String internationalScheduledPaymentId) {
    ...
    public OBWriteDataInternationalScheduledResponse2 consentId(String consentId) {
    ...
    public OBWriteDataInternationalScheduledResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse2 status(OBExternalStatus1Code status) {
        this.status = status;
        return this;
    }
    ...
    public OBWriteDataInternationalScheduledResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse2 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse2 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
    ...
    public OBWriteDataInternationalScheduledResponse2 charges(List<OBCharge1> charges) {
        this.charges = charges;
        return this;
    }

    public OBWriteDataInternationalScheduledResponse2 addChargesItem(OBCharge1 chargesItem) {
    ...
    public OBWriteDataInternationalScheduledResponse2 exchangeRateInformation(OBExchangeRate2 exchangeRateInformation) {
    ...
    public OBWriteDataInternationalScheduledResponse2 initiation(OBInternationalScheduled2 initiation) {
    ...
    public OBWriteDataInternationalScheduledResponse2 multiAuthorisation(OBMultiAuthorisation1 multiAuthorisation) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDataInternationalScheduledResponse2 obWriteDataInternationalScheduledResponse2 = (OBWriteDataInternationalScheduledResponse2) o;
        return Objects.equals(this.internationalScheduledPaymentId, obWriteDataInternationalScheduledResponse2.internationalScheduledPaymentId) &&
                Objects.equals(this.consentId, obWriteDataInternationalScheduledResponse2.consentId) &&
                Objects.equals(this.creationDateTime, obWriteDataInternationalScheduledResponse2.creationDateTime) &&
                Objects.equals(this.status, obWriteDataInternationalScheduledResponse2.status) &&
                Objects.equals(this.statusUpdateDateTime, obWriteDataInternationalScheduledResponse2.statusUpdateDateTime) &&
                Objects.equals(this.expectedExecutionDateTime, obWriteDataInternationalScheduledResponse2.expectedExecutionDateTime) &&
                Objects.equals(this.expectedSettlementDateTime, obWriteDataInternationalScheduledResponse2.expectedSettlementDateTime) &&
                Objects.equals(this.charges, obWriteDataInternationalScheduledResponse2.charges) &&
                Objects.equals(this.exchangeRateInformation, obWriteDataInternationalScheduledResponse2.exchangeRateInformation) &&
                Objects.equals(this.initiation, obWriteDataInternationalScheduledResponse2.initiation) &&
                Objects.equals(this.multiAuthorisation, obWriteDataInternationalScheduledResponse2.multiAuthorisation);
    }
