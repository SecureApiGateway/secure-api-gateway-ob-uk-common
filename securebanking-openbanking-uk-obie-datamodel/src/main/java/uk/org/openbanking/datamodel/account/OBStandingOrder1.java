...
public class OBStandingOrder1 {
    ...
    public OBStandingOrder1 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBStandingOrder1 nextPaymentDateTime(OffsetDateTime nextPaymentDateTime) {
    ...
    public OBStandingOrder1 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
