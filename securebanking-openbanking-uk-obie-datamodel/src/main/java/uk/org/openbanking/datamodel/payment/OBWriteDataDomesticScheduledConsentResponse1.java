...
public class OBWriteDataDomesticScheduledConsentResponse1 {
    ...
    public OBWriteDataDomesticScheduledConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse1 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticScheduledConsentResponse1 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
