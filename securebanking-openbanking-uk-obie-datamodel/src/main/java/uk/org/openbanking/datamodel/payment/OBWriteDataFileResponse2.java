...
public class OBWriteDataFileResponse2 {
    ...
    public OBWriteDataFileResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataFileResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
