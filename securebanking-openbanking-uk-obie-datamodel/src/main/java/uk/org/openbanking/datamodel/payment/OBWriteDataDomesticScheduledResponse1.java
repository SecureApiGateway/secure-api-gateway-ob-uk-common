...
public class OBWriteDataDomesticScheduledResponse1 {
    ...
    public OBWriteDataDomesticScheduledResponse1 creationDateTime(DateTime creationDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse1 statusUpdateDateTime(DateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse1 expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticScheduledResponse1 expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
