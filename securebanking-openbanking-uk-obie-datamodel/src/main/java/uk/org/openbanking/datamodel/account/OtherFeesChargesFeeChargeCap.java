...
public class OtherFeesChargesFeeChargeCap {
  ...
  **/
   ...
   * @return feeCapAmount
  **/
 @Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$")  @ApiModelProperty(value = "Cap amount charged for a fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  **/
  ...
  public OtherFeesChargesFeeChargeCap otherFeeType(List<OBBCAData1OtherFeeType> otherFeeType) {
    this.otherFeeType = otherFeeType;
    return this;
  }

  public OtherFeesChargesFeeChargeCap addOtherFeeTypeItem(OBBCAData1OtherFeeType otherFeeTypeItem) {
