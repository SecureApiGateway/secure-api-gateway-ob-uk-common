...
public class OBWriteDataInternationalStandingOrderConsentResponse1 {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
