...
public class OBWriteDataFileConsentResponse1 {
    ...
    public OBWriteDataFileConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataFileConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataFileConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
