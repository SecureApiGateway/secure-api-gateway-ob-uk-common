...
public class OBStandingOrder4 {
    ...
    public OBStandingOrder4 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBStandingOrder4 nextPaymentDateTime(OffsetDateTime nextPaymentDateTime) {
    ...
    public OBStandingOrder4 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
