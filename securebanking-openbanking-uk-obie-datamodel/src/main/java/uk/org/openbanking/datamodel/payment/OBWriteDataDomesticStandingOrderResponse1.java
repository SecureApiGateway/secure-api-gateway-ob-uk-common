...
public class OBWriteDataDomesticStandingOrderResponse1 {
    ...
    public OBWriteDataDomesticStandingOrderResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticStandingOrderResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
