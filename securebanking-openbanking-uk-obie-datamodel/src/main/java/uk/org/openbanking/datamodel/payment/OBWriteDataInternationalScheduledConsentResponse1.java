...
public class OBWriteDataInternationalScheduledConsentResponse1 {
    ...
    public OBWriteDataInternationalScheduledConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse1 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataInternationalScheduledConsentResponse1 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
