...
public class OBWriteInternationalConsentResponse4Data {
    ...
    public OBWriteInternationalConsentResponse4Data creationDateTime(DateTime creationDateTime) {
    ...
    public OBWriteInternationalConsentResponse4Data statusUpdateDateTime(DateTime statusUpdateDateTime) {
    ...
    public OBWriteInternationalConsentResponse4Data cutOffDateTime(DateTime cutOffDateTime) {
    ...
    public OBWriteInternationalConsentResponse4Data expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
    ...
    public OBWriteInternationalConsentResponse4Data expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
