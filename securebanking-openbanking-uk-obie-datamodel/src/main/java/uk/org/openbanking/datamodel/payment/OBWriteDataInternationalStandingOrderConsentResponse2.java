...
public class OBWriteDataInternationalStandingOrderConsentResponse2 {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataInternationalStandingOrderConsentResponse2 cutOffDateTime(OffsetDateTime cutOffDateTime) {
