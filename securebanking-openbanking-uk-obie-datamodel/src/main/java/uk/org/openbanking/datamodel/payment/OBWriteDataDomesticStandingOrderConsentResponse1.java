...
public class OBWriteDataDomesticStandingOrderConsentResponse1 {
    ...
    public OBWriteDataDomesticStandingOrderConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticStandingOrderConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticStandingOrderConsentResponse1 cutOffDateTime(OffsetDateTime cutOffDateTime) {
