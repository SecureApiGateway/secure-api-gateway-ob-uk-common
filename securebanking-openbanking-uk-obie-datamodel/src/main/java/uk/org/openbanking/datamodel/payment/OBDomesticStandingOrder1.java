...
public class OBDomesticStandingOrder1 {
    ...
    public OBDomesticStandingOrder1 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBDomesticStandingOrder1 recurringPaymentDateTime(OffsetDateTime recurringPaymentDateTime) {
    ...
    public OBDomesticStandingOrder1 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
