...
public class OBMultiAuthorisation1 {
    ...
    public OBMultiAuthorisation1 lastUpdateDateTime(OffsetDateTime lastUpdateDateTime) {
    ...
    public OBMultiAuthorisation1 expirationDateTime(OffsetDateTime expirationDateTime) {
