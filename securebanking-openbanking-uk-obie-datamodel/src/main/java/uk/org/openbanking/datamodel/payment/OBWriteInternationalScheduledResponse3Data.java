...
public class OBWriteInternationalScheduledResponse3Data {
    ...
    public OBWriteInternationalScheduledResponse3Data creationDateTime(DateTime creationDateTime) {
    ...
    public OBWriteInternationalScheduledResponse3Data statusUpdateDateTime(DateTime statusUpdateDateTime) {
    ...
    public OBWriteInternationalScheduledResponse3Data expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
    ...
    public OBWriteInternationalScheduledResponse3Data expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
