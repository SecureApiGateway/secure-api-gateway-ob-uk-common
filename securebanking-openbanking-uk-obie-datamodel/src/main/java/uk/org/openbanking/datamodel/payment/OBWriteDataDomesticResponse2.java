...
public class OBWriteDataDomesticResponse2 {
    ...
    public OBWriteDataDomesticResponse2 domesticPaymentId(String domesticPaymentId) {
    ...
    public OBWriteDataDomesticResponse2 consentId(String consentId) {
    ...
    public OBWriteDataDomesticResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataDomesticResponse2 status(OBTransactionIndividualStatus1Code status) {
        this.status = status;
        return this;
    }
    ...
    public OBWriteDataDomesticResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticResponse2 expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticResponse2 expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
    ...
    public OBWriteDataDomesticResponse2 charges(List<OBCharge1> charges) {
        this.charges = charges;
        return this;
    }

    public OBWriteDataDomesticResponse2 addChargesItem(OBCharge1 chargesItem) {
    ...
    public OBWriteDataDomesticResponse2 initiation(OBDomestic2 initiation) {
    ...
    public OBWriteDataDomesticResponse2 multiAuthorisation(OBMultiAuthorisation1 multiAuthorisation) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDataDomesticResponse2 obWriteDataDomesticResponse2 = (OBWriteDataDomesticResponse2) o;
