...
public class OBWriteInternationalResponse4Data {
    ...
    public OBWriteInternationalResponse4Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteInternationalResponse4Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteInternationalResponse4Data expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteInternationalResponse4Data expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
