...
public class OBWriteDomesticScheduledConsentResponse3Data {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data permission(OBExternalPermissions2Code permission) {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDomesticScheduledConsentResponse3Data expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
