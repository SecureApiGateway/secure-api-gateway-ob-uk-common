...
public class OBReadProduct2DataOtherProductTypeRepaymentOtherAmountType {
   ...
   * @return code
  **/
 @Pattern(regexp="^\\w{0,4}$")  @ApiModelProperty(value = "")
  ...
  **/
  @NotNull
 @Size(min=1,max=350)  @ApiModelProperty(required = true, value = "")
  ...
  **/
  @NotNull
 @Size(min=1,max=70)  @ApiModelProperty(required = true, value = "")
