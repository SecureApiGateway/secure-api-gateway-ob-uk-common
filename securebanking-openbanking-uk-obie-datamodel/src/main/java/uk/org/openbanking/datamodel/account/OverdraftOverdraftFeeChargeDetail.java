...
public class OverdraftOverdraftFeeChargeDetail {
  ...
  **/
   ...
   * @return feeAmount
  **/
 @Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$")  @ApiModelProperty(value = "Amount charged for an overdraft fee/charge (where it is charged in terms of an amount rather than a rate)")
   ...
   * @return feeRate
  **/
 @Pattern(regexp="^(-?\\d{1,3}){1}(\\.\\d{1,4}){0,1}$")  @ApiModelProperty(value = "Rate charged for overdraft fee/charge (where it is charged in terms of a rate rather than an amount)")
  ...
  **/
 @Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$")  @ApiModelProperty(value = "Every additional tranche of an overdraft balance to which an overdraft fee is applied")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationFrequency, calculationFrequency, feeAmount, feeRate, feeRateType, feeType, incrementalBorrowingAmount, negotiableIndicator, notes, otherApplicationFrequency, otherCalculationFrequency, otherFeeRateType, otherFeeType, overdraftControlIndicator, overdraftFeeChargeCap);
  }
