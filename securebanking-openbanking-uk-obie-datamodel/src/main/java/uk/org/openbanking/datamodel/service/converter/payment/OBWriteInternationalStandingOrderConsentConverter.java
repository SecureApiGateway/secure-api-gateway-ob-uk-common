...
public class OBWriteInternationalStandingOrderConsentConverter {
    ...
    public static PermissionEnum toOBWriteInternationalStandingOrderConsent5DataPermission(OBExternalPermissions2Code permission) {
    ...
    public static OBWriteInternationalStandingOrderConsent6Data.PermissionEnum toOBWriteInternationalStandingOrderConsent6DataPermission(PermissionEnum permission) {
        return permission == null ? null : OBWriteInternationalStandingOrderConsent6Data.PermissionEnum.valueOf(permission.name());
    }
}
