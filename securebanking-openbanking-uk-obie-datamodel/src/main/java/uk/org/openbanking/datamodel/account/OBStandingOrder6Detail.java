...
public class OBStandingOrder6Detail {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accountId, creditorAccount, creditorAgent, finalPaymentAmount, finalPaymentDateTime, firstPaymentAmount, firstPaymentDateTime, frequency, lastPaymentAmount, lastPaymentDateTime, nextPaymentAmount, nextPaymentDateTime, numberOfPayments, reference, standingOrderId, standingOrderStatusCode, supplementaryData);
    }
