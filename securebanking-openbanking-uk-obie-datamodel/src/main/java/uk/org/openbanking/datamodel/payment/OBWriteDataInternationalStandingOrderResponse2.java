...
public class OBWriteDataInternationalStandingOrderResponse2 {
    ...
    public OBWriteDataInternationalStandingOrderResponse2 creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDataInternationalStandingOrderResponse2 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
