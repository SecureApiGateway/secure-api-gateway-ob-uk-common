...
public class OBInternationalStandingOrder1 {
    ...
    public OBInternationalStandingOrder1 firstPaymentDateTime(OffsetDateTime firstPaymentDateTime) {
    ...
    public OBInternationalStandingOrder1 finalPaymentDateTime(OffsetDateTime finalPaymentDateTime) {
