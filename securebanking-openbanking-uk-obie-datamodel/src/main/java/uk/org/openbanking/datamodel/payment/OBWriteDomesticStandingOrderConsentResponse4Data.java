...
public class OBWriteDomesticStandingOrderConsentResponse4Data {
    ...
    public OBWriteDomesticStandingOrderConsentResponse4Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDomesticStandingOrderConsentResponse4Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDomesticStandingOrderConsentResponse4Data permission(OBExternalPermissions2Code permission) {
    ...
    public OBWriteDomesticStandingOrderConsentResponse4Data cutOffDateTime(OffsetDateTime cutOffDateTime) {
