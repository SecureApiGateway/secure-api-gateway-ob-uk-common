...
public class OBWriteDomesticConsentResponse3Data {
    ...
    public OBWriteDomesticConsentResponse3Data creationDateTime(OffsetDateTime creationDateTime) {
    ...
    public OBWriteDomesticConsentResponse3Data statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
    ...
    public OBWriteDomesticConsentResponse3Data cutOffDateTime(OffsetDateTime cutOffDateTime) {
    ...
    public OBWriteDomesticConsentResponse3Data expectedExecutionDateTime(OffsetDateTime expectedExecutionDateTime) {
    ...
    public OBWriteDomesticConsentResponse3Data expectedSettlementDateTime(OffsetDateTime expectedSettlementDateTime) {
