...
/**
 * Represents {@code OBCallbackUrlData1} in the OB data model. Note that {@code OBCallbackUrl1} is skipped in this
 * domain model since it only contains {@code OBCallbackUrlData1}.
 *
 * <p>
