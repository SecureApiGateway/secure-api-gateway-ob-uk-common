 ...
 */
package com.forgerock.securebanking.common.openbanking.uk.forgerock.datamodel.event;
 ...
 *
 * <p>The EventNotification API Specification describes the object <code>OBEventNotification2</code> that contains the
 * events claim. However, this object is not defined in the swagger specification. Instead the spec defines
 * {@link OBEventNotification1}.
 *
 * <p>This object has been created to provide a collection of events. It is intended to be isolated within
 * {@link FRDataEvent} for the following purposes only:
 * <ul>
 *     <li>Import events</li>
 *     <li>Update events</li>
 *     <li>Remove events</li>
