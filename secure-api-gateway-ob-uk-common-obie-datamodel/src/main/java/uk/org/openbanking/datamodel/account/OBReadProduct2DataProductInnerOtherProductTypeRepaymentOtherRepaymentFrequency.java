...
@Schema(name = "OBReadProduct2_Data_Product_inner_OtherProductType_Repayment_OtherRepaymentFrequency", description = "Other repayment frequency which is not in the standard code list")
@JsonTypeName("OBReadProduct2_Data_Product_inner_OtherProductType_Repayment_OtherRepaymentFrequency")
