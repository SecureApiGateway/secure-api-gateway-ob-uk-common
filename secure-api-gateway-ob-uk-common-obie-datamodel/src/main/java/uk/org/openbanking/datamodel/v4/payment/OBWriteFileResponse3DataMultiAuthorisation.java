...
@Schema(name = "OBWriteFileResponse3_Data_MultiAuthorisation", description = "The multiple authorisation flow response from the ASPSP.")
@JsonTypeName("OBWriteFileResponse3_Data_MultiAuthorisation")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class OBWriteFileResponse3DataMultiAuthorisation {

    private OBWriteFileResponse3DataMultiAuthorisationStatus status;
    ...
    public OBWriteFileResponse3DataMultiAuthorisation() {
        super();
    }
     ...
     */
    public OBWriteFileResponse3DataMultiAuthorisation(OBWriteFileResponse3DataMultiAuthorisationStatus status) {
        this.status = status;
    }

    public OBWriteFileResponse3DataMultiAuthorisation status(OBWriteFileResponse3DataMultiAuthorisationStatus status) {
        this.status = status;
        return this;
    }
    ...
    @JsonProperty("Status")
    public OBWriteFileResponse3DataMultiAuthorisationStatus getStatus() {
        return status;
    }

    public void setStatus(OBWriteFileResponse3DataMultiAuthorisationStatus status) {
        this.status = status;
    }

    public OBWriteFileResponse3DataMultiAuthorisation numberRequired(Integer numberRequired) {
    ...
    public OBWriteFileResponse3DataMultiAuthorisation numberReceived(Integer numberReceived) {
    ...
    public OBWriteFileResponse3DataMultiAuthorisation lastUpdateDateTime(DateTime lastUpdateDateTime) {
    ...
    public OBWriteFileResponse3DataMultiAuthorisation expirationDateTime(DateTime expirationDateTime) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteFileResponse3DataMultiAuthorisation obWriteFileResponse3DataMultiAuthorisation = (OBWriteFileResponse3DataMultiAuthorisation) o;
        return Objects.equals(this.status, obWriteFileResponse3DataMultiAuthorisation.status) &&
                Objects.equals(this.numberRequired, obWriteFileResponse3DataMultiAuthorisation.numberRequired) &&
                Objects.equals(this.numberReceived, obWriteFileResponse3DataMultiAuthorisation.numberReceived) &&
                Objects.equals(this.lastUpdateDateTime, obWriteFileResponse3DataMultiAuthorisation.lastUpdateDateTime) &&
                Objects.equals(this.expirationDateTime, obWriteFileResponse3DataMultiAuthorisation.expirationDateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteFileResponse3DataMultiAuthorisation {\n");
