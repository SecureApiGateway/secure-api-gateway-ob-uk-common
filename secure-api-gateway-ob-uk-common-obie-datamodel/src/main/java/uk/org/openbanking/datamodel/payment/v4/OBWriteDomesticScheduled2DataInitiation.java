...
public class OBWriteDomesticScheduled2DataInitiation {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instructionIdentification, endToEndIdentification, localInstrument, requestedExecutionDateTime, instructedAmount, debtorAccount, creditorAccount, creditorPostalAddress, ultimateCreditor, ultimateDebtor, remittanceInformation, supplementaryData);
    }
