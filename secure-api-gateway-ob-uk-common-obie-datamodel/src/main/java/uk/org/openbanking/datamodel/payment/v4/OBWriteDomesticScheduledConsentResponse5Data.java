...
public class OBWriteDomesticScheduledConsentResponse5Data {
    ...
    private OBWriteDomesticScheduledConsentResponse5DataStatusCode statusCode;
     ...
     */
    public OBWriteDomesticScheduledConsentResponse5Data(String consentId, DateTime creationDateTime, OBWriteDomesticScheduledConsentResponse5DataStatusCode statusCode, DateTime statusUpdateDateTime, OBWriteDomesticScheduledConsent4DataPermission permission, OBWriteDomesticScheduledConsent4DataInitiation initiation) {
    ...
    public OBWriteDomesticScheduledConsentResponse5Data statusCode(OBWriteDomesticScheduledConsentResponse5DataStatusCode statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    ...
    public OBWriteDomesticScheduledConsentResponse5DataStatusCode getStatusCode() {
        return statusCode;
    }

    public void setStatusCode(OBWriteDomesticScheduledConsentResponse5DataStatusCode statusCode) {
        this.statusCode = statusCode;
    }
    ...
    public OBWriteDomesticScheduledConsentResponse5Data statusReason(List<@Valid OBStatusReason> statusReason) {
        this.statusReason = statusReason;
        return this;
    }

    public OBWriteDomesticScheduledConsentResponse5Data addStatusReasonItem(OBStatusReason statusReasonItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.consentId, obWriteDomesticScheduledConsentResponse5Data.consentId) &&
                ...
                Objects.equals(this.statusCode, obWriteDomesticScheduledConsentResponse5Data.statusCode) &&
                Objects.equals(this.statusUpdateDateTime, obWriteDomesticScheduledConsentResponse5Data.statusUpdateDateTime) &&
                Objects.equals(this.statusReason, obWriteDomesticScheduledConsentResponse5Data.statusReason) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(consentId, creationDateTime, statusCode, statusUpdateDateTime, statusReason, permission, readRefundAccount, cutOffDateTime, expectedExecutionDateTime, expectedSettlementDateTime, charges, initiation, authorisation, scASupportData, debtor);
    }
