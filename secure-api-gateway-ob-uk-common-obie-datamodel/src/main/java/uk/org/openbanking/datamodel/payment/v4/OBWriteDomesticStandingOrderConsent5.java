...
public class OBWriteDomesticStandingOrderConsent5 {
    ...
    private OBWriteDomesticStandingOrderConsent5Data data;

    private OBRisk1 risk;

    public OBWriteDomesticStandingOrderConsent5() {
        super();
    }
     ...
     */
    public OBWriteDomesticStandingOrderConsent5(OBWriteDomesticStandingOrderConsent5Data data, OBRisk1 risk) {
        this.data = data;
        this.risk = risk;
    }
