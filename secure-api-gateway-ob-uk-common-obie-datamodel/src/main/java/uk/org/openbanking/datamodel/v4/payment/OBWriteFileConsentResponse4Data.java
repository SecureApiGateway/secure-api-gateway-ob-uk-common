...
public class OBWriteFileConsentResponse4Data {
    ...
    public OBWriteFileConsentResponse4Data authorisation(OBWriteDomesticConsentDataAuthorisation authorisation) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(consentId, creationDateTime, status, statusReason, statusUpdateDateTime, cutOffDateTime, charges, initiation, authorisation, scASupportData, debtor);
    }
