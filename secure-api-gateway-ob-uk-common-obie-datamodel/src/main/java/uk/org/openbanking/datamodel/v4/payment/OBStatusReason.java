...
public class OBStatusReason {
     ...
     */
    @Size(min = 1, max = 500)
    @Schema(name = "Path", description = "Path is optional but relevant when the status reason refers to an object/field and hence conditional to provide JSON path.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("Path")
