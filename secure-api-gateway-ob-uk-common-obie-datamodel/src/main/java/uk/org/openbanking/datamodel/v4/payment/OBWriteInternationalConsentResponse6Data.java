...
public class OBWriteInternationalConsentResponse6Data {
     ...
     */
    public OBWriteInternationalConsentResponse6Data(String consentId, DateTime creationDateTime, OBWriteInternationalConsentResponse6DataStatus status, DateTime statusUpdateDateTime, OBWriteInternational3DataInitiation initiation) {
    ...
    public OBWriteInternationalConsentResponse6Data authorisation(OBWriteDomesticConsentDataAuthorisation authorisation) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(consentId, creationDateTime, status, statusReason, statusUpdateDateTime, readRefundAccount, cutOffDateTime, expectedExecutionDateTime, expectedSettlementDateTime, charges, exchangeRateInformation, initiation, authorisation, scASupportData, debtor);
    }
