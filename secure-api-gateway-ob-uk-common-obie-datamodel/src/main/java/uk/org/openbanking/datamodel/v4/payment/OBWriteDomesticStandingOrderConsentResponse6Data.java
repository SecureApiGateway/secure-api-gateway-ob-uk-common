...
public class OBWriteDomesticStandingOrderConsentResponse6Data {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(consentId, creationDateTime, status, statusUpdateDateTime, statusReason, permission, readRefundAccount, cutOffDateTime, charges, initiation, authorisation, scASupportData, debtor);
    }
