...
public class OBWritePaymentDetailsResponse1Data {
    ...
    public OBWritePaymentDetailsResponse1Data paymentStatus(List<@Valid OBWritePaymentDetails1> paymentStatus) {
        this.paymentStatus = paymentStatus;
        return this;
    }

    public OBWritePaymentDetailsResponse1Data addPaymentStatusItem(OBWritePaymentDetails1 paymentStatusItem) {
