...
@Schema(name = "OBWriteFileConsent3_Data_Initiation", description = "The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds using a payment file.")
@JsonTypeName("OBWriteFileConsent3_Data_Initiation")
...
public class OBWriteFileConsent3DataInitiation {
    ...
    public OBWriteFileConsent3DataInitiation fileType(String fileType) {
        this.fileType = fileType;
        return this;
    }
    ...
    public OBWriteFileConsent3DataInitiation fileHash(String fileHash) {
        this.fileHash = fileHash;
        return this;
    }
    ...
    public OBWriteFileConsent3DataInitiation fileReference(String fileReference) {
    ...
    public OBWriteFileConsent3DataInitiation numberOfTransactions(String numberOfTransactions) {
    ...
    public OBWriteFileConsent3DataInitiation controlSum(BigDecimal controlSum) {
    ...
    public OBWriteFileConsent3DataInitiation requestedExecutionDateTime(DateTime requestedExecutionDateTime) {
    ...
    public OBWriteFileConsent3DataInitiation localInstrument(String localInstrument) {
    ...
    public OBWriteFileConsent3DataInitiation creditorAgent(OBWriteDomestic2DataInitiationCreditorAgent creditorAgent) {
    ...
    public OBWriteFileConsent3DataInitiation debtorAccount(OBWriteDomestic2DataInitiationDebtorAccount debtorAccount) {
    ...
    public OBWriteFileConsent3DataInitiation ultimateDebtor(OBUltimateDebtor1 ultimateDebtor) {
    ...
    public OBWriteFileConsent3DataInitiation remittanceInformation(OBRemittanceInformation2 remittanceInformation) {
    ...
    public OBWriteFileConsent3DataInitiation supplementaryData(OBSupplementaryData1 supplementaryData) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteFileConsent3DataInitiation obWriteFileConsent3DataInitiation = (OBWriteFileConsent3DataInitiation) o;
        return Objects.equals(this.fileType, obWriteFileConsent3DataInitiation.fileType) &&
                Objects.equals(this.fileHash, obWriteFileConsent3DataInitiation.fileHash) &&
                Objects.equals(this.fileReference, obWriteFileConsent3DataInitiation.fileReference) &&
                Objects.equals(this.numberOfTransactions, obWriteFileConsent3DataInitiation.numberOfTransactions) &&
                Objects.equals(this.controlSum, obWriteFileConsent3DataInitiation.controlSum) &&
                Objects.equals(this.requestedExecutionDateTime, obWriteFileConsent3DataInitiation.requestedExecutionDateTime) &&
                Objects.equals(this.localInstrument, obWriteFileConsent3DataInitiation.localInstrument) &&
                Objects.equals(this.creditorAgent, obWriteFileConsent3DataInitiation.creditorAgent) &&
                Objects.equals(this.debtorAccount, obWriteFileConsent3DataInitiation.debtorAccount) &&
                Objects.equals(this.ultimateDebtor, obWriteFileConsent3DataInitiation.ultimateDebtor) &&
                Objects.equals(this.remittanceInformation, obWriteFileConsent3DataInitiation.remittanceInformation) &&
                Objects.equals(this.supplementaryData, obWriteFileConsent3DataInitiation.supplementaryData);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteFileConsent3DataInitiation {\n");
