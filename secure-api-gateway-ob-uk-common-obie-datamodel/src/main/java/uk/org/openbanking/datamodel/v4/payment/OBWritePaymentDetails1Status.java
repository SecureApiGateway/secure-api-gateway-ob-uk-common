...
public enum OBWritePaymentDetails1Status {
    ...
    OBWritePaymentDetails1Status(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OBWritePaymentDetails1Status fromValue(String value) {
        for (OBWritePaymentDetails1Status b : OBWritePaymentDetails1Status.values()) {
