...
public class OBWriteInternationalStandingOrderConsentResponse7Data {
     ...
     */
    public OBWriteInternationalStandingOrderConsentResponse7Data(String consentId, DateTime creationDateTime, OBWriteDomesticConsentResponse5DataStatusCode statusCode, DateTime statusUpdateDateTime, OBWriteDomesticScheduledConsent4DataPermission permission, OBWriteInternationalStandingOrderConsentResponse7DataInitiation initiation) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7Data statusCode(OBWriteDomesticConsentResponse5DataStatusCode statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.consentId, obWriteInternationalStandingOrderConsentResponse7Data.consentId) &&
                ...
                Objects.equals(this.statusCode, obWriteInternationalStandingOrderConsentResponse7Data.statusCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(consentId, creationDateTime, statusCode, statusReason, statusUpdateDateTime, permission, readRefundAccount, cutOffDateTime, charges, initiation, authorisation, scASupportData, debtor);
    }
