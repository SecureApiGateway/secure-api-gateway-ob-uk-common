...
@Schema(name = "OBWriteDomestic2_Data_Initiation_DebtorAccount", description = "Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction.")
@JsonTypeName("OBWriteDomestic2_Data_Initiation_DebtorAccount")
...
public class OBWriteDomestic2DataInitiationDebtorAccount {
     ...
     */
    public OBWriteDomestic2DataInitiationDebtorAccount(String schemeName, String identification) {
    ...
    public OBWriteDomestic2DataInitiationDebtorAccount proxy(OBProxy1 proxy) {
        this.proxy = proxy;
        return this;
    }
