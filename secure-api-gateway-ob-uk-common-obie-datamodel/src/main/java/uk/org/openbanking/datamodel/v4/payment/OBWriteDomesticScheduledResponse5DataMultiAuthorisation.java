...
@Schema(name = "OBWriteDomesticScheduledResponse5_Data_MultiAuthorisation", description = "The multiple authorisation flow response from the ASPSP.")
@JsonTypeName("OBWriteDomesticScheduledResponse5_Data_MultiAuthorisation")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class OBWriteDomesticScheduledResponse5DataMultiAuthorisation {

    private OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatus status;
    ...
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation() {
        super();
    }
     ...
     */
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation(OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatus status) {
        this.status = status;
    }

    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation status(OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatus status) {
        this.status = status;
        return this;
    }
    ...
    @JsonProperty("Status")
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatus getStatus() {
        return status;
    }

    public void setStatus(OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatus status) {
        this.status = status;
    }

    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation numberRequired(Integer numberRequired) {
    ...
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation numberReceived(Integer numberReceived) {
    ...
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation lastUpdateDateTime(DateTime lastUpdateDateTime) {
    ...
    public OBWriteDomesticScheduledResponse5DataMultiAuthorisation expirationDateTime(DateTime expirationDateTime) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDomesticScheduledResponse5DataMultiAuthorisation obWriteDomesticScheduledResponse5DataMultiAuthorisation = (OBWriteDomesticScheduledResponse5DataMultiAuthorisation) o;
        return Objects.equals(this.status, obWriteDomesticScheduledResponse5DataMultiAuthorisation.status) &&
                Objects.equals(this.numberRequired, obWriteDomesticScheduledResponse5DataMultiAuthorisation.numberRequired) &&
                Objects.equals(this.numberReceived, obWriteDomesticScheduledResponse5DataMultiAuthorisation.numberReceived) &&
                Objects.equals(this.lastUpdateDateTime, obWriteDomesticScheduledResponse5DataMultiAuthorisation.lastUpdateDateTime) &&
                Objects.equals(this.expirationDateTime, obWriteDomesticScheduledResponse5DataMultiAuthorisation.expirationDateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteDomesticScheduledResponse5DataMultiAuthorisation {\n");
