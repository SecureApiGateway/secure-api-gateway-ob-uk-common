...
@Schema(name = "OBWriteInternationalStandingOrderResponse7_Data_Refund_Creditor", description = "Set of elements used to identify a person or an organisation.")
@JsonTypeName("OBWriteInternationalStandingOrderResponse7_Data_Refund_Creditor")
...
public class OBWriteInternationalStandingOrderResponse7DataRefundCreditor {
    ...
    public OBWriteInternationalStandingOrderResponse7DataRefundCreditor LEI(String LEI) {
        this.LEI = LEI;
        return this;
    }
    ...
    public OBWriteInternationalStandingOrderResponse7DataRefundCreditor postalAddress(OBPostalAddress7 postalAddress) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, obWriteInternationalStandingOrderResponse7DataRefundCreditor.name) &&
                Objects.equals(this.LEI, obWriteInternationalStandingOrderResponse7DataRefundCreditor.LEI) &&
