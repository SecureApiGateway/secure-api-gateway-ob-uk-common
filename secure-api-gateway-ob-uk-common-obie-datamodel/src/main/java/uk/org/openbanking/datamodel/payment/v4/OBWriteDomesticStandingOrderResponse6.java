...
public class OBWriteDomesticStandingOrderResponse6 {
    ...
    private OBWriteDomesticStandingOrderResponse6Data data;

    private Links links;

    private Meta meta;

    public OBWriteDomesticStandingOrderResponse6() {
        super();
    }
     ...
     */
    public OBWriteDomesticStandingOrderResponse6(OBWriteDomesticStandingOrderResponse6Data data) {
        this.data = data;
    }
