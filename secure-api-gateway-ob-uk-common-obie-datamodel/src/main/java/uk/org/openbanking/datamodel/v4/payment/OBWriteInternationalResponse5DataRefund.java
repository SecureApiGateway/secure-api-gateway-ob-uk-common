...
public class OBWriteInternationalResponse5DataRefund {
    ...
    private OBWriteInternationalResponse5DataRefundAccount account;
     ...
     */
    public OBWriteInternationalResponse5DataRefund(OBWriteInternationalResponse5DataRefundAccount account) {
    ...
    public OBWriteInternationalResponse5DataRefund account(OBWriteInternationalResponse5DataRefundAccount account) {
        this.account = account;
        return this;
    }
    ...
    public OBWriteInternationalResponse5DataRefundAccount getAccount() {
        return account;
    }

    public void setAccount(OBWriteInternationalResponse5DataRefundAccount account) {
        this.account = account;
    }
