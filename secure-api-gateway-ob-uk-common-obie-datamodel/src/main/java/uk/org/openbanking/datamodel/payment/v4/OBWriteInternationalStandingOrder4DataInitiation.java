...
public class OBWriteInternationalStandingOrder4DataInitiation {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(remittanceInformation, purpose, chargeBearer, currencyOfTransfer, destinationCountryCode, instructedAmount, debtorAccount, creditor, creditorAgent, creditorAccount, ultimateCreditor, ultimateDebtor, regulatoryReporting, supplementaryData);
    }
