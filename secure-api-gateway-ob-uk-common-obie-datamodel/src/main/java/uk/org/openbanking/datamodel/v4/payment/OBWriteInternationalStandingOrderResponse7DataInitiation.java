...
@Schema(name = "OBWriteInternationalStandingOrderResponse7_Data_Initiation", description = "The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for an international standing order.")
@JsonTypeName("OBWriteInternationalStandingOrderResponse7_Data_Initiation")
...
public class OBWriteInternationalStandingOrderResponse7DataInitiation {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation() {
        super();
    }
     ...
     */
    public OBWriteInternationalStandingOrderResponse7DataInitiation(String currencyOfTransfer, OBWriteDomestic2DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrder4DataInitiationCreditorAccount creditorAccount) {
        this.currencyOfTransfer = currencyOfTransfer;
        this.instructedAmount = instructedAmount;
        this.creditorAccount = creditorAccount;
    }

    public OBWriteInternationalStandingOrderResponse7DataInitiation purpose(String purpose) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation extendedPurpose(String extendedPurpose) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation chargeBearer(OBInternalChargeBearerType1Code chargeBearer) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation currencyOfTransfer(String currencyOfTransfer) {
        this.currencyOfTransfer = currencyOfTransfer;
        return this;
    }
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation destinationCountryCode(String destinationCountryCode) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation instructedAmount(OBWriteDomestic2DataInitiationInstructedAmount instructedAmount) {
        this.instructedAmount = instructedAmount;
        return this;
    }
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation debtorAccount(OBWriteDomestic2DataInitiationDebtorAccount debtorAccount) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation creditor(OBWriteInternationalScheduledConsentResponse6DataInitiationCreditor creditor) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation creditorAgent(OBWriteInternationalStandingOrder4DataInitiationCreditorAgent creditorAgent) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation creditorAccount(OBWriteInternationalStandingOrder4DataInitiationCreditorAccount creditorAccount) {
        this.creditorAccount = creditorAccount;
        return this;
    }
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation ultimateCreditor(OBUltimateCreditor1 ultimateCreditor) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation ultimateDebtor(OBUltimateDebtor1 ultimateDebtor) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation regulatoryReporting(List<@Valid OBRegulatoryReporting1> regulatoryReporting) {
        this.regulatoryReporting = regulatoryReporting;
        return this;
    }

    public OBWriteInternationalStandingOrderResponse7DataInitiation addRegulatoryReportingItem(OBRegulatoryReporting1 regulatoryReportingItem) {
    ...
    public OBWriteInternationalStandingOrderResponse7DataInitiation supplementaryData(OBSupplementaryData1 supplementaryData) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteInternationalStandingOrderResponse7DataInitiation obWriteInternationalStandingOrderResponse7DataInitiation = (OBWriteInternationalStandingOrderResponse7DataInitiation) o;
        return Objects.equals(this.purpose, obWriteInternationalStandingOrderResponse7DataInitiation.purpose) &&
                Objects.equals(this.extendedPurpose, obWriteInternationalStandingOrderResponse7DataInitiation.extendedPurpose) &&
                Objects.equals(this.chargeBearer, obWriteInternationalStandingOrderResponse7DataInitiation.chargeBearer) &&
                Objects.equals(this.currencyOfTransfer, obWriteInternationalStandingOrderResponse7DataInitiation.currencyOfTransfer) &&
                Objects.equals(this.destinationCountryCode, obWriteInternationalStandingOrderResponse7DataInitiation.destinationCountryCode) &&
                Objects.equals(this.instructedAmount, obWriteInternationalStandingOrderResponse7DataInitiation.instructedAmount) &&
                Objects.equals(this.debtorAccount, obWriteInternationalStandingOrderResponse7DataInitiation.debtorAccount) &&
                Objects.equals(this.creditor, obWriteInternationalStandingOrderResponse7DataInitiation.creditor) &&
                Objects.equals(this.creditorAgent, obWriteInternationalStandingOrderResponse7DataInitiation.creditorAgent) &&
                Objects.equals(this.creditorAccount, obWriteInternationalStandingOrderResponse7DataInitiation.creditorAccount) &&
                Objects.equals(this.ultimateCreditor, obWriteInternationalStandingOrderResponse7DataInitiation.ultimateCreditor) &&
                Objects.equals(this.ultimateDebtor, obWriteInternationalStandingOrderResponse7DataInitiation.ultimateDebtor) &&
                Objects.equals(this.regulatoryReporting, obWriteInternationalStandingOrderResponse7DataInitiation.regulatoryReporting) &&
                Objects.equals(this.supplementaryData, obWriteInternationalStandingOrderResponse7DataInitiation.supplementaryData);
    }

    @Override
    public int hashCode() {
        return Objects.hash(purpose, extendedPurpose, chargeBearer, currencyOfTransfer, destinationCountryCode, instructedAmount, debtorAccount, creditor, creditorAgent, creditorAccount, ultimateCreditor, ultimateDebtor, regulatoryReporting, supplementaryData);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class OBWriteInternationalStandingOrderResponse7DataInitiation {\n");
