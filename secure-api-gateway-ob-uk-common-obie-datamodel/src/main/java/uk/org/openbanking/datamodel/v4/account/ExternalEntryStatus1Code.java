...
public enum ExternalEntryStatus1Code {
    ...
    ExternalEntryStatus1Code(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ExternalEntryStatus1Code fromValue(String value) {
        for (ExternalEntryStatus1Code b : ExternalEntryStatus1Code.values()) {
