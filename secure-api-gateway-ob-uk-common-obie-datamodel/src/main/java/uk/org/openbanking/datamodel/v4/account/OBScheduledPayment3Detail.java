...
public class OBScheduledPayment3Detail {
     ...
     */
    public OBScheduledPayment3Detail(String accountId, DateTime scheduledPaymentDateTime, OBInternalScheduleType1Code scheduledType, OBActiveOrHistoricCurrencyAndAmount1 instructedAmount, OBCashAccount51 creditorAccount) {
    ...
    public OBScheduledPayment3Detail scheduledType(OBInternalScheduleType1Code scheduledType) {
        this.scheduledType = scheduledType;
        return this;
    }
