...
public class OBWriteDomesticStandingOrderResponse6Data {
    ...
    private OBWriteDomesticStandingOrderResponse6DataStatus status;
    ...
    public OBWriteDomesticStandingOrderResponse6Data status(OBWriteDomesticStandingOrderResponse6DataStatus status) {
        this.status = status;
        return this;
    }
    ...
    @JsonProperty("Status")
    public OBWriteDomesticStandingOrderResponse6DataStatus getStatus() {
        return status;
    }

    public void setStatus(OBWriteDomesticStandingOrderResponse6DataStatus status) {
        this.status = status;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(domesticStandingOrderId, consentId, creationDateTime, status, statusUpdateDateTime, statusReason, refund, charges, initiation, multiAuthorisation, debtor);
    }
