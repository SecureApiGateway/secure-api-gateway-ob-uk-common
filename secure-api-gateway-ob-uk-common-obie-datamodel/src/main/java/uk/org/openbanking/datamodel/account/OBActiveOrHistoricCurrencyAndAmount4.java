...
@Schema(name = "OBActiveOrHistoricCurrencyAndAmount_4", description = "The amount of the final Standing Order")
@JsonTypeName("OBActiveOrHistoricCurrencyAndAmount_4")
