...
public class OBWriteDataDomesticResponse2 {
    ...
    public OBWriteDataDomesticResponse2 creationDateTime(DateTime creationDateTime) {
    ...
    public OBWriteDataDomesticResponse2 statusUpdateDateTime(DateTime statusUpdateDateTime) {
    ...
    public OBWriteDataDomesticResponse2 expectedExecutionDateTime(DateTime expectedExecutionDateTime) {
    ...
    public OBWriteDataDomesticResponse2 expectedSettlementDateTime(DateTime expectedSettlementDateTime) {
