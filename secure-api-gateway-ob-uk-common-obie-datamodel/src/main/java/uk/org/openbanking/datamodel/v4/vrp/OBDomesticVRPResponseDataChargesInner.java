...
public class OBDomesticVRPResponseDataChargesInner {
    ...
    private OBInternalPaymentChargeType1Code type;
     ...
     */
    public OBDomesticVRPResponseDataChargesInner(OBInternalChargeBearerType1Code chargeBearer, OBInternalPaymentChargeType1Code type, OBActiveOrHistoricCurrencyAndAmount amount) {
        this.chargeBearer = chargeBearer;
        this.type = type;
        this.amount = amount;
    }

    public OBDomesticVRPResponseDataChargesInner chargeBearer(OBInternalChargeBearerType1Code chargeBearer) {
        this.chargeBearer = chargeBearer;
        return this;
    }
    ...
    public OBDomesticVRPResponseDataChargesInner type(OBInternalPaymentChargeType1Code type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty("Type")
    public OBInternalPaymentChargeType1Code getType() {
        return type;
    }

    public void setType(OBInternalPaymentChargeType1Code type) {
        this.type = type;
    }
