...
public enum OBExternalPurpose1Code {
    ...
    OBExternalPurpose1Code(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OBExternalPurpose1Code fromValue(String value) {
        for (OBExternalPurpose1Code b : OBExternalPurpose1Code.values()) {
