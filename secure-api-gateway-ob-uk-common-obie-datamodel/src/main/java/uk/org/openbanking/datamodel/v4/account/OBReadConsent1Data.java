...
public class OBReadConsent1Data {
     ...
     */
    public OBReadConsent1Data(List<@Valid OBInternalPermissions1Code> permissions) {
        this.permissions = permissions;
    }

    public OBReadConsent1Data permissions(List<@Valid OBInternalPermissions1Code> permissions) {
        this.permissions = permissions;
        return this;
    }

    public OBReadConsent1Data addPermissionsItem(OBInternalPermissions1Code permissionsItem) {
