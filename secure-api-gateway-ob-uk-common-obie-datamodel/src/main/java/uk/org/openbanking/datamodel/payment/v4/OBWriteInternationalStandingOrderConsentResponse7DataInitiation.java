...
@Schema(name = "OBWriteInternationalStandingOrderConsentResponse7_Data_Initiation", description = "The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for an international standing order.")
@JsonTypeName("OBWriteInternationalStandingOrderConsentResponse7_Data_Initiation")
...
public class OBWriteInternationalStandingOrderConsentResponse7DataInitiation {
     ...
     */
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation(String currencyOfTransfer, OBWriteDomestic2DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrder4DataInitiationCreditorAccount creditorAccount) {
        this.currencyOfTransfer = currencyOfTransfer;
        this.instructedAmount = instructedAmount;
        this.creditorAccount = creditorAccount;
    }

    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation remittanceInformation(OBRemittanceInformation2 remittanceInformation) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation chargeBearer(OBInternalChargeBearerType1Code chargeBearer) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation ultimateCreditor(OBUltimateCreditor1 ultimateCreditor) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation ultimateDebtor(OBUltimateDebtor1 ultimateDebtor) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation regulatoryReporting(List<@Valid OBRegulatoryReporting1> regulatoryReporting) {
        this.regulatoryReporting = regulatoryReporting;
        return this;
    }

    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation addRegulatoryReportingItem(OBRegulatoryReporting1 regulatoryReportingItem) {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiation mandateRelatedInformation(OBMandateRelatedInformation1 mandateRelatedInformation) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.remittanceInformation, obWriteInternationalStandingOrderConsentResponse7DataInitiation.remittanceInformation) &&
                ...
                Objects.equals(this.ultimateCreditor, obWriteInternationalStandingOrderConsentResponse7DataInitiation.ultimateCreditor) &&
                Objects.equals(this.ultimateDebtor, obWriteInternationalStandingOrderConsentResponse7DataInitiation.ultimateDebtor) &&
                Objects.equals(this.regulatoryReporting, obWriteInternationalStandingOrderConsentResponse7DataInitiation.regulatoryReporting) &&
                Objects.equals(this.mandateRelatedInformation, obWriteInternationalStandingOrderConsentResponse7DataInitiation.mandateRelatedInformation) &&
                Objects.equals(this.supplementaryData, obWriteInternationalStandingOrderConsentResponse7DataInitiation.supplementaryData);
    }

    @Override
    public int hashCode() {
        return Objects.hash(remittanceInformation, purpose, chargeBearer, currencyOfTransfer, destinationCountryCode, instructedAmount, debtorAccount, creditor, creditorAgent, creditorAccount, ultimateCreditor, ultimateDebtor, regulatoryReporting, mandateRelatedInformation, supplementaryData);
    }
