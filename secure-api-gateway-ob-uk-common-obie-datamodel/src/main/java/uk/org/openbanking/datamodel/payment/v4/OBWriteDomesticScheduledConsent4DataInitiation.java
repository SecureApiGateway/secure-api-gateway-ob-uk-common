...
@Schema(name = "OBWriteDomesticScheduledConsent4_Data_Initiation", description = "The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a single scheduled domestic payment.")
@JsonTypeName("OBWriteDomesticScheduledConsent4_Data_Initiation")
...
public class OBWriteDomesticScheduledConsent4DataInitiation {
     ...
     */
    public OBWriteDomesticScheduledConsent4DataInitiation(String instructionIdentification, DateTime requestedExecutionDateTime, OBWriteDomestic2DataInitiationInstructedAmount instructedAmount, OBWriteDomestic2DataInitiationCreditorAccount creditorAccount) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation instructionIdentification(String instructionIdentification) {
        this.instructionIdentification = instructionIdentification;
        return this;
    }
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation endToEndIdentification(String endToEndIdentification) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation localInstrument(String localInstrument) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation requestedExecutionDateTime(DateTime requestedExecutionDateTime) {
        this.requestedExecutionDateTime = requestedExecutionDateTime;
        return this;
    }
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation instructedAmount(OBWriteDomestic2DataInitiationInstructedAmount instructedAmount) {
        this.instructedAmount = instructedAmount;
        return this;
    }
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation debtorAccount(OBWriteDomestic2DataInitiationDebtorAccount debtorAccount) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation creditorAccount(OBWriteDomestic2DataInitiationCreditorAccount creditorAccount) {
        this.creditorAccount = creditorAccount;
        return this;
    }
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation creditorPostalAddress(OBPostalAddress7 creditorPostalAddress) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation ultimateCreditor(OBUltimateCreditor1 ultimateCreditor) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation ultimateDebtor(OBUltimateDebtor1 ultimateDebtor) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation regulatoryReporting(List<@Valid OBRegulatoryReporting1> regulatoryReporting) {
        this.regulatoryReporting = regulatoryReporting;
        return this;
    }

    public OBWriteDomesticScheduledConsent4DataInitiation addRegulatoryReportingItem(OBRegulatoryReporting1 regulatoryReportingItem) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation remittanceInformation(OBRemittanceInformation2 remittanceInformation) {
    ...
    public OBWriteDomesticScheduledConsent4DataInitiation supplementaryData(OBSupplementaryData1 supplementaryData) {
    ...
    public boolean equals(Object o) {
        ...
        OBWriteDomesticScheduledConsent4DataInitiation obWriteDomesticScheduledConsent4DataInitiation = (OBWriteDomesticScheduledConsent4DataInitiation) o;
        return Objects.equals(this.instructionIdentification, obWriteDomesticScheduledConsent4DataInitiation.instructionIdentification) &&
                Objects.equals(this.endToEndIdentification, obWriteDomesticScheduledConsent4DataInitiation.endToEndIdentification) &&
                Objects.equals(this.localInstrument, obWriteDomesticScheduledConsent4DataInitiation.localInstrument) &&
                Objects.equals(this.requestedExecutionDateTime, obWriteDomesticScheduledConsent4DataInitiation.requestedExecutionDateTime) &&
                Objects.equals(this.instructedAmount, obWriteDomesticScheduledConsent4DataInitiation.instructedAmount) &&
                Objects.equals(this.debtorAccount, obWriteDomesticScheduledConsent4DataInitiation.debtorAccount) &&
                Objects.equals(this.creditorAccount, obWriteDomesticScheduledConsent4DataInitiation.creditorAccount) &&
                Objects.equals(this.creditorPostalAddress, obWriteDomesticScheduledConsent4DataInitiation.creditorPostalAddress) &&
                Objects.equals(this.ultimateCreditor, obWriteDomesticScheduledConsent4DataInitiation.ultimateCreditor) &&
                Objects.equals(this.ultimateDebtor, obWriteDomesticScheduledConsent4DataInitiation.ultimateDebtor) &&
                Objects.equals(this.regulatoryReporting, obWriteDomesticScheduledConsent4DataInitiation.regulatoryReporting) &&
                Objects.equals(this.remittanceInformation, obWriteDomesticScheduledConsent4DataInitiation.remittanceInformation) &&
                Objects.equals(this.supplementaryData, obWriteDomesticScheduledConsent4DataInitiation.supplementaryData);
    }
    ...
    public String toString() {
        ...
        sb.append("class OBWriteDomesticScheduledConsent4DataInitiation {\n");
