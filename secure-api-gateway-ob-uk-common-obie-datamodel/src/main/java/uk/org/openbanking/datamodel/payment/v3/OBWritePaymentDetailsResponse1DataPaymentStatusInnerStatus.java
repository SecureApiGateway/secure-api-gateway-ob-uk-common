...
public enum OBWritePaymentDetailsResponse1DataPaymentStatusInnerStatus {
    ...
    OBWritePaymentDetailsResponse1DataPaymentStatusInnerStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OBWritePaymentDetailsResponse1DataPaymentStatusInnerStatus fromValue(String value) {
        for (OBWritePaymentDetailsResponse1DataPaymentStatusInnerStatus b : OBWritePaymentDetailsResponse1DataPaymentStatusInnerStatus.values()) {
