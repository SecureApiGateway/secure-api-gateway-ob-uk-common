...
public class OBStandingOrder5Basic {
    ...
    public OBStandingOrder5Basic firstPaymentDateTime(DateTime firstPaymentDateTime) {
    ...
    public OBStandingOrder5Basic nextPaymentDateTime(DateTime nextPaymentDateTime) {
    ...
    public OBStandingOrder5Basic finalPaymentDateTime(DateTime finalPaymentDateTime) {
