...
public class OBFrequency6 {
    ...
    @Schema(name = "CountPerPeriod", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    /**
     * Exact2NumericText - Further information on the exact point in time the event should take place
     *
     * @return pointInTime
     */
    @Size(max = 2)
    @Schema(name = "PointInTime", description = "Exact2NumericText - Further information on the exact point in time the event should take place", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
