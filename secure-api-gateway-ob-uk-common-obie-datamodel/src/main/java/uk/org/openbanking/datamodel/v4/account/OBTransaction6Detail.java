...
public class OBTransaction6Detail {
     ...
     */
    public OBTransaction6Detail(String accountId, OBCreditDebitCode1 creditDebitIndicator, ExternalEntryStatus1Code status, DateTime bookingDateTime, OBActiveOrHistoricCurrencyAndAmount9 amount) {
