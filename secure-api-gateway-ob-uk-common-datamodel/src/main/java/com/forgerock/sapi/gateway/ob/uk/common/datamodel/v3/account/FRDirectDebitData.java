 ...
 * the OB object), in order to make it easier to introduce new versions of the Read/Write API.
 *
 * <p>
...
@AllArgsConstructor
@Builder
public class FRDirectDebitData {
    ...
    public enum FRDirectDebitStatus {
        ...
        FRDirectDebitStatus(String value) {
            this.value = value;
        }
        ...
        public static FRDirectDebitStatus fromValue(String value) {
