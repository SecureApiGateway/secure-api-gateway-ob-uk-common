...
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.common.FRCreditorAgent;
...
public class FRAccountIdentifierConverter {
    ...
    public static FRCreditorAgent toFRCreditorAgent(OBWriteDomestic2DataInitiationCreditorAgent creditorAgent) {
        return FRModelMapper.map(creditorAgent, FRCreditorAgent.class);
    }

    public static FRCreditorAgent toFRCreditorAgent(OBUltimateCreditor1 creditorAgent) {
        return FRModelMapper.map(creditorAgent, FRCreditorAgent.class);
    }

    public static FRCreditorAgent toFRCreditorAgent(OBUltimateDebtor1 creditorAgent) {
        return FRModelMapper.map(creditorAgent, FRCreditorAgent.class);
    }
    ...
    public static OBWriteDomestic2DataInitiationCreditorAgent toOBWriteDomestic2DataInitiationCreditorAgent(FRCreditorAgent account) {
        return FRModelMapper.map(account, OBWriteDomestic2DataInitiationCreditorAgent.class);
    }

    public static OBUltimateCreditor1 toOBWriteDomestic2DataInitiationUltimateCreditor(FRCreditorAgent account) {
        return FRModelMapper.map(account, OBUltimateCreditor1.class);
    }

    public static OBUltimateDebtor1 toOBWriteDomestic2DataInitiationUltimateDebtor(FRCreditorAgent account) {
