...
/**
 * Represents {@code OBReadConsentResponse1} in the OB data model. It is stored within mongo (instead of the OB object),
...
@AllArgsConstructor
@Builder
public class FRReadConsentResponse {

    private FRReadConsentResponseData data;
