...
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.account.FRReadDataResponse;
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.account.FRReadResponse;
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.converter.common.FRLinksConverter;
...
public class FRReadResponseConverter {
    ...
    public static FRReadResponse toFRReadResponse(OBReadResponse1 response) {
        return response == null ? null : FRReadResponse.builder()
                ...
                .risk(FRRiskConverter.toFRAccountRisk((OBRisk2) response.getRisk()))
    ...
    public static OBReadResponse1 toOBReadResponse1(FRReadResponse response) {
        return response == null ? null : new OBReadResponse1()
                ...
                .risk(FRRiskConverter.toOBRisk2(response.getRisk()))
