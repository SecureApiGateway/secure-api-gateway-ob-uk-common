...
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.common.*;
...
import com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.payment.FRWriteDomesticDataInitiation;
...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.v4.converter.payment.FRDataSCASupportDataConverter.toFRDataSCASupportData;
...
public class FRWriteDomesticConsentConverter {
    ...
    public static FRWriteDomesticDataInitiation toFRWriteDomesticDataInitiation(OBWriteDomestic2DataInitiation initiation) {
        return initiation == null ? null : FRWriteDomesticDataInitiation.builder()
                ...
                .creditorAgent(FRAccountIdentifierConverter.toFRCreditorAgent(initiation.getCreditorAgent()))
    ...
    public static OBWriteDomestic2DataInitiation toOBWriteDomestic2DataInitiation(FRWriteDomesticDataInitiation initiation) {
        return initiation == null ? null : new OBWriteDomestic2DataInitiation()
                ...
                .creditorAgent(FRAccountIdentifierConverter.toOBWriteDomestic2DataInitiationCreditorAgent(initiation.getCreditorAgent()))
