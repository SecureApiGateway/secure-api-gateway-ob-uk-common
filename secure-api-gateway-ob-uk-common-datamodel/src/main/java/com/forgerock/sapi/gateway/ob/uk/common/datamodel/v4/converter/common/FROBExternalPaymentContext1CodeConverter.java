...
public class FROBExternalPaymentContext1CodeConverter {
    ...
    // FR to OB
    public static OBRisk1PaymentContextCode toOBExternalPaymentContext1Code(FRExternalPaymentContextCode frExternalPaymentContextCode) {
        return frExternalPaymentContextCode == null ? null : OBRisk1PaymentContextCode.valueOf(frExternalPaymentContextCode.name());
    }
