 ...
 */
package com.forgerock.sapi.gateway.ob.uk.common.datamodel.v3.converter.mapper;
...
public class FRModelMapper {
    ...
    private static final Converter<List<String>, String> LIST_TO_SINGLE_STRING_CONVERTER = context -> ConversionUtils.convertListToSingleString(context.getSource());
