...
/**
 * Represents {@code OBOffer1} in the OB data model. It is stored within mongo (instead of the OB object),
...
public class FROfferData {
    ...
    private FRAmount fee;

    public enum FROfferType {
        ...
        public static FROfferType fromValue(String value) {
