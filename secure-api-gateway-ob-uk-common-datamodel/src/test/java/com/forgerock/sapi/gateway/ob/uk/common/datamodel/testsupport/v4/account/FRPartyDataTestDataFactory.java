...
import static com.forgerock.sapi.gateway.ob.uk.common.datamodel.testsupport.FRPostalAddressTestDataFactory.aValidFRPostalAddress7;
...
public class FRPartyDataTestDataFactory {
    ...
    public static FRPartyData aValidFRPartyData() {
        return FRPartyData.builder()
                ...
                .mobile("07970712345")
                .addresses(List.of(aValidFRPostalAddress7()))
