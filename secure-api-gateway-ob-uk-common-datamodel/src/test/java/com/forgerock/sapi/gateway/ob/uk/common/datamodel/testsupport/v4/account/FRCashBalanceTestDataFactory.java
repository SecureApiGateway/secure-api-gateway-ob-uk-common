...
public class FRCashBalanceTestDataFactory {
    ...
    public static FRCashBalanceData aValidFRCashBalanceData() {
        return aValidFRCashBalanceDataBuilder()
                .build();
    }
    ...
    /**
     * @return an instance of {@link FRCashBalanceData.FRCashBalanceDataBuilder} with the required values populated.
     */
    public static FRCashBalanceData.FRCashBalanceDataBuilder aValidFRCashBalanceDataBuilder() {
        return FRCashBalanceData.builder()
                .balance(List.of(aValidFRCashBalance()))
                .totalValue(aValidFRTotalValue());
    }
